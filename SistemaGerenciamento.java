...
public class SistemaGerenciamento {
    ...
    public static void main(String[] args) {
        funcionarios.add(new Gerente("Maria", 8000));
        funcionarios.add(new Desenvolvedor("Lucas", 5000));
        funcionarios.add(new Desenvolvedor("Ricardo", 7000));
        funcionarios.add(new Estagiario("Thales", 2000));

        calcularFolhaPagamento();
        promoverFuncionario("Thales");
        calcularFolhaPagamento();
    }
